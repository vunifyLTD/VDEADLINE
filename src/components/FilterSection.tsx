...
import { Search, X, ChevronDown, CheckCircle2, Circle, Star, FileText, Filter, List, Calendar } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { isUpcomingDeadline } from '../utils/dateUtils';
import * as Tooltip from '@radix-ui/react-tooltip';
import { Link, useLocation } from 'react-router-dom';
import { getSubmissionsByCategory, getSubmissionsBySubcategory } from '../utils/filterUtils';
...
const FilterSection: React.FC<FilterSectionProps> = ({
    ...
    const getSubcategoryCounts = (subcategoryId: string) => {
        ...
        const subcategorySubmissions = getSubmissionsBySubcategory(allSubmissions, subcategoryId);
    ...
    const getCategoryCounts = (categoryId: string) => {
        ...
        const categorySubmissions = getSubmissionsByCategory(allSubmissions, categoryId);
